...
class ResetPasswordRequestToken(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # done
            return CustomResponse(succeeded=True,message='Token has been sent to your email', data={}, status=status.HTTP_200_OK)
        except Exception as e:
            return CustomResponse(succeeded=False,message=str(e.args), data={}, status=status.HTTP_400_BAD_REQUEST)
